...
```{r}
gs <- "https://docs.google.com/spreadsheets/d/13hT8Zls3PcOG-LuJomQclcd530HJ6kFnujLRAYnKoVY/edit?gid=984447818#gid=984447818" %>% 
  as_sheets_id()
...
6. Prueba de comparación de medias(Tukey -SNK - Duncan)
7. Graficar
